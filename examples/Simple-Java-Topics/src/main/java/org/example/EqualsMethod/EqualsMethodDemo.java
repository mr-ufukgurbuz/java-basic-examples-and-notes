package org.example.EqualsMethod;
...
public class EqualsMethodDemo {
    public static void main(String[] args) {
        ...
        Person person1 = new Person(1,"Person");
        Person person2 = new Person(1,"Person");
        ...
        String text1 = "Deneme123";
        String text2 = "Deneme123456".substring(0,9);
