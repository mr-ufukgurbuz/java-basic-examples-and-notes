...
public class MultithreadingDemo {
    public static void main(String[] args) {
        CharWriter charWriter = new CharWriter('A',5);
        NumberWriter numberWriter = new NumberWriter(14,5);
        CharWriter charWriter2 = new CharWriter('B',2);

        // is parcagina ait thread olusturalim

        Thread isparcasi1 = new Thread(charWriter);
        isparcasi1.start();

        Thread isparcasi2 = new Thread(numberWriter);
        isparcasi2.start();

        Thread isparcasi3 = new Thread(charWriter2);
        isparcasi3.start();
